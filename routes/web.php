...
//Role 0 for superadmin and 1 for admin 
...
Route::middleware('role:admin')->group(function () {
    ...
    // Route for checking customer phone
    Route::post('/check-customer-phone', [PosController::class, 'checkCustomerPhone'])->name('check.customer.phone');

    // Route for saving customer phone
    Route::post('/save-customer-phone', [PosController::class, 'saveCustomerPhone'])->name('save.customer.phone');
    ...
    // Route::get('/pos/{customer_id}/invoice', [PosController::class, 'invoiceCreate'])->name('pos.create.invoice');
    Route::get('/pos/invoice/{customer_id}', [PosController::class, 'invoiceCreate'])->name('pos.create.invoice');
