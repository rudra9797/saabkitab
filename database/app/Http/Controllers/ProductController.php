...
class ProductController extends Controller
{
    ...
    {
        $row =  Product::with(['category', 'unit'])->where(['user_id'=>Auth::user()->id])->count();       
    ...
    public function store(Request $request)
    {
        ...
        if(isset($request->pos_name))
            $redirectURL = 'pos.index';
        else
        ...
        $rules = [
            ...
            'stock' => 'required|numeric|between:0,99999.99',
            'buying_price' => 'required|decimal:0,2',
            'selling_price' => 'required|decimal:0,2',
            'our_price' => 'nullable|decimal:0,2',
        ];
        ...
        return Redirect::route($redirectURL)->with('success', 'Product has been created!');
    }
