                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            <!-- Form Group (name) -->
                            <div class="col-md-6">
                                <label class="small mb-1" for="ref_name">Referrer Name <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="ref_phone">Referrer Phone number <span class="text-danger">*</span></label>
