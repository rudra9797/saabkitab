                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <!-- Form Group (advance_amount) -->
                            <div class="col-md-6">
                                <label class="small mb-1" for="advance_amount">Advance Amount <span class="text-danger">*</span></label>
                                <input class="form-control form-control-solid @error('advance_amount') is-invalid @enderror" id="advance_amount" name="advance_amount" type="text" placeholder="" value="{{ old('advance_amount', $customer->advance_amount) }}" />
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('ref_name') is-invalid @enderror" id="ref_name" name="ref_name" type="text" placeholder="" value="{{ old('ref_name', $customer->ref_name) }}" />
                                @error('ref_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('ref_phone') is-invalid @enderror" id="ref_phone" name="ref_phone" type="text" placeholder="" value="{{ old('ref_phone', $customer->ref_phone) }}" />
                                @error('ref_phone')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
