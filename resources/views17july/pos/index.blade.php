                                    ...
                                    <form action="{{ route('pos.updateCartItem', $item->rowId) }}" method="POST">
                                        ...
                                        <td style="min-width: 75px;">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control px-2" name="price" required value="{{ old('price', $item->price) }}">
                                        ...
                                        <td style="min-width: 120px;">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control px-2" name="qty" required value="{{ old('qty', $item->qty) }}">
        ...
        <div class="col-xl-6">
            ...
            <div class="card mb-4 mb-xl-0">
                <div class="card-header">List Product
                    <button class="btn btn-primary add-list mx-1 float-end" type="button" data-bs-toggle="modal" data-bs-target="#modal" id="addProductButton"> Add Product</button>
                </div>
                ...
                <div class="card-body">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <select class="form-control" name="row">
                                            ...
                                            <option value="50" @if(request('row')=='50' OR request('row')=='' )selected="selected" @endif>50</option>
                    ...
                    <div class="col-lg-12">
                        ...
                        <td>
                            <div class="d-flex ">
                                <form class="mb-1 mt-1" action="{{ route('pos.addCartItem', $product->id) }}" method="POST">
                                    @csrf
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="" id="pos_name" name="pos_name" type="hidden" value="1" />
