                ...
                <div class="modal-body">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control form-control-solid @error('pay') is-invalid @enderror" id="pay" name="pay" placeholder="" value="{{ old('pay') }}" autocomplete="off" required/>
                            @error('pay')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
