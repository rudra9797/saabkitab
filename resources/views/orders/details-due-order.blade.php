...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('order.dueOrders') }}">Orders</a></li>
    ...
    <div class="card-header">
        ...
        <div class="row">
            <div class="col-md-6  my-2">
                <h6 class="m-0 font-weight-bold text-primary">Due Order Details</h6>
            </div>
            ...
            <div class="col-xl-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Submit button -->
                        <button class="btn btn-success" id="PayDueButton" type="button"  data-toggle="modal" data-target="#modal">Pay Due</button>
                                ...
                                <table class="table table-striped align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td scope="row">{{ $item->actual_unitcost }}</td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-center mx-auto" id="modalCenterTitle">Invoice of {{ $order->customer->name }}<br />Total Amount <b>{{ $order->total }}</b>
                @if($order->payment_type=='fromBalance') 
                </br> Balance Advance Amount <b>{{$order->customer->advance_amount}}</b>   
                @endif
            </h3>
            </div>
...
@if (count($errors) > 0)
    <script type="text/javascript">
        window.onload = function() {
            var hangoutButton = document.getElementById("PayDueButton");
