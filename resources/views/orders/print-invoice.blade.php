...
<div class="invoice-16 invoice-content">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="invoice-inner-9" id="invoice_wrapper" style="background: #fff;border: 1px solid rgba(0, 0, 0, 0.1);box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);">
                    <div class="invoice-top" style="background: #fff;">
                        <div class="row">
                    ...
                    <div class="invoice-info" style="background: #fff;">
                        <div class="row">
                    ...
                    <div class="order-summary" style="background: #fff;">
