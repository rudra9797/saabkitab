...
class CustomerController extends Controller
{
    ...
    {
        $row =  Customer::where(['user_id'=>Auth::user()->id])->count();       
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            // 'bank_name' => 'max:25',
            //'advance_amount' => 'string|max:25',
            // 'ref_phone' => 'required|string|max:25',
            // 'ref_name' => 'required|string|max:25',
